...
// NOTE: this was used at an earlier stage for testing all methods at once. The methods haven't changed - the new version still works, but some have moved around now and the depencies are slightly different. We have evidence of all of the Unit tests working perfectly prior to the upgrades to the software, so get in touch with gulliverjohnson@gmail.com if you want to double check them. I'm leaving this code here for documentation purposes later!
